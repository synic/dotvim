...
utils.map_keys({
  ...
  { "<leader>wmh", "<cmd>wincmd H<cr>", desc = "Move window left", silent = true },
  { "<leader>wmj", "<cmd>wincmd J<cr>", desc = "Move window down", silent = true },
  { "<leader>wmk", "<cmd>wincmd K<cr>", desc = "Move window up", silent = true },
  { "<leader>wml", "<cmd>wincmd L<cr>", desc = "Move window right", silent = true },
